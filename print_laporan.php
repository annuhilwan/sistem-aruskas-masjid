<?php
/**
 * SAVE LAPORAN SEBAGAI PDF - METODE PRINT BROWSER
 * Cara paling reliable: Print ke PDF menggunakan browser
 */
...
<head>
    ...
    <title>Laporan Arus Kas Masjid - Print</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="instruction">
            <strong>📌 Cara Save sebagai PDF:</strong>
            <ol style="margin-left: 20px; margin-top: 5px;">
                <li>Tekan <strong>Ctrl+P</strong> (atau <strong>Cmd+P</strong> di Mac)</li>
                <li>Pilih printer: <strong>"Save to PDF"</strong> atau <strong>"Print to File"</strong></li>
                <li>Klik <strong>Save</strong></li>
                <li>Pilih folder tujuan dan nama file</li>
            </ol>
        </div>
        ...
        <div class="footer">
            ...
            <p>&copy; <?php echo date('Y'); ?> - Manajemen Keuangan Masjid</p>
        </div>
    </div>
    
    <script>
        // Auto print ketika page load
        window.addEventListener('load', function() {
            // Uncomment baris di bawah jika ingin auto-print saat page load
            // window.print();
        });
    </script>
</body>
